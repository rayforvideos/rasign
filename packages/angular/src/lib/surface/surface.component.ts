...
const elevationMap: Record<Elevation, string> = {
  sm: 'elevationSm', md: 'elevationMd', lg: 'elevationLg', xl: 'elevationXl',
};

const roundedMap: Record<Rounded, string> = {
  sm: 'roundedSm', md: 'roundedMd', lg: 'roundedLg', xl: 'roundedXl', full: 'roundedFull',
};
...
@Component({
  ...
  template: `
    @switch (tag()) {
      @case ('section') { <section [class]="classes()" [style.padding]="paddingStyle()"><ng-content /></section> }
      @case ('article') { <article [class]="classes()" [style.padding]="paddingStyle()"><ng-content /></article> }
      @case ('aside') { <aside [class]="classes()" [style.padding]="paddingStyle()"><ng-content /></aside> }
      @default { <div [class]="classes()" [style.padding]="paddingStyle()"><ng-content /></div> }
    }
  `,
  styles: [],
