...
describe('Typography', () => {
  ...
  test('renders with as prop', () => {
    render(<Typography as="h1" variant="heading-xl">Title</Typography>);
    const el = screen.getByText('Title');
    expect(el.tagName).toBe('H1');
  });

  test('renders as anchor with href', () => {
    render(<Typography as="a" href="/test" variant="body">Link</Typography>);
  ...
  test('merges custom className', () => {
    render(<Typography variant="body" className="custom">Text</Typography>);
    const el = screen.getByText('Text');
