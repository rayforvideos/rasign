...
function UserCard() {
  return React.createElement(Surface, { as: 'article', elevation: 'md', rounded: 'lg', padding: '4' },
    React.createElement(Row, { gap: '4', align: 'center' },
      React.createElement(Avatar, { initials: 'JD', size: 'lg' }),
      React.createElement(Column, { gap: '1', style: { flex: 1 } },
        React.createElement(Row, { gap: '2', align: 'center' },
